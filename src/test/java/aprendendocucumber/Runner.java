...
@CucumberOptions(plugin = "pretty", monochrome = true, snippets = SnippetType.CAMELCASE, dryRun = false, glue = "")
...
//strict = false = se for colocano um novo passo no cenário este marcador dão deixa passar o teste se não estiver presente
